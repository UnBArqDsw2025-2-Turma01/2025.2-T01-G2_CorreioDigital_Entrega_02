...
Este documento apresenta um relatório detalhado das contribuições e participações de cada membro da equipe **Correio Digital** durante a segunda entrega da disciplina de **Arquitetura e Desenho de Software**. O objetivo é documentar de forma transparente e rastreável o trabalho desenvolvido por cada integrante, garantindo visibilidade sobre as responsabilidades assumidas e os resultados entregues.

A documentação está organizada em três módulos principais, correspondentes aos focos estabelecidos para esta entrega:

- **Módulo Modelagem Estática (Foco 1)**: Documenta os diagramas de classes, componentes e pacotes.
- **Módulo Modelagem Estática (Foco 2)**: Documenta os diagramas de atividades, comunicação, estados e sequência.
- **Módulo Modelagem Organizacional (Foco 3)**: Documenta os diagramas de usuário, casos de uso geral e diagrama administrador.
...
|Nome do Membro | Contribuição | Significância da Contribuição para o Projeto (Excelente/Boa/Regular/Ruim/Nula) | Comprobatórios Claros (com link)|
|-|-|-|-|
|[Esther Sena Martins](https://github.com/esmsena)| Criação do diagrama de usuário e sua documentação, Elaboração do diagrama | Excelente | [Diagrama de Usuário](https://github.com/UnBArqDsw2025-2-Turma01/2025.2-T01-G2_CorreioDigital_Entrega_02/commits?author=esmsena) |
...
| `1.8` | 22/09/2025 | Adição da participação da integrante Esther Sena| [Esther Sena Martins](https://github.com/esmsena) | - | - |
| `1.9` | 22/09/2025 | Adição da participação do integrante Pedro Ferreira Gondim | [Pedro Ferreira Gondim](https://github.com/G0ndim) | - | - |
