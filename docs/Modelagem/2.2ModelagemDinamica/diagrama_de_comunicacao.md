...
| `1.2`  | 16/09/2025 | Atualização arrumando o caminho de imagens de Gameficação e Chat e adicionando legenda e autora de ambos. | [Mariiana Siqueira Neris](https://github.com/Maryyscreuza) |  |  |
| `1.3`  | 16/09/2025 | Adicionando imagens e responsávéis pelo cenário 1 e 2 de acordo com os outros cenários adicionados |[Esther Sena](https://github.com/esmsena) |  |  |
